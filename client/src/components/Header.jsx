...
const Header = () => {
  ...
  return (
    <div className='flex  items-center justify-between max-sm:flex-col-reverse gap-y-10 mt-10 lg:px-44 sm:mt-20'>
      <div >
        ...
        <div>
            <input onChange={e => removeBg(e.target.files[0])} className='hidden' type='file' accept='image/*' id='upload1' />
